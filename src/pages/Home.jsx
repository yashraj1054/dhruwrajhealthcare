  ...
  <div className="max-w-7xl mx-auto px-6 text-center">
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
      ...
      {[
        ...
        { name: "Hair & Skin", img: "/images/Diseases/hair-and-skin.png" },
...
<section className="bg-[#FDFBF3] py-24">
  <div className="max-w-7xl mx-auto px-6 text-center">
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
      ...
      {[
        { name: "Shirodhara", img: "/images/Therapy/shirodhara.jpg" },
        { name: "Abhyanga", img: "/images/Therapy/abhyanga.jpg" },
        { name: "Nasya", img: "/images/Therapy/nasya.jpg" },
        { name: "Janu Basti", img: "/images/Therapy/janubasti.jpg" },
        { name: "Kati Basti", img: "/images/Therapy/kati-basti.jpg" },
        { name: "Ayurvedic Facial", img: "/images/Therapy/face-massage.jpg" },
      ].map((item, index) => (
        <div
          key={index}
          className="bg-white rounded-2xl shadow-md hover:shadow-xl transition duration-300 hover:-translate-y-2 cursor-pointer overflow-hidden"
        >
          <img
            src={item.img}
            alt={item.name}
          ...
          <div className="py-5 text-lg font-semibold text-[#C4531A]">
            {item.name}
          </div>
        </div>
      ))}
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center px-6">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6">
              With 13+ years of experience in Ayurveda & Panchkarma,
              Dr. R.K Pal has successfully treated thousands of patients, 
              blending profound traditional wisdom with the rigorous standards of modern clinical practice. His journey is defined by a rare combination of academic excellence, high-level corporate clinical experience, and a deep-seated commitment to medical education.
              <br/>
              <br />
              ...
              <br/>
              <br />
Dr. Pal’s profound expertise is backed by an elite academic foundation:
<br />
<ul>
  <li><strong>1. B.A.M.S.</strong> (Bachelor of Ayurvedic Medicine and Surgery)</li>
  <li><strong>2. M.D. – Panchakarma</strong> (Specialist in Bio-cleansing and Detoxification)</li>
  <li><strong>3. C.A.R.D. (Mumbai)</strong> (Certificate in Ayurvedic Rheumatology & Disorders)</li>
  <li><strong>4. Ph.D. (Scholar)</strong> (Advancing research in evidence-based Ayurveda)</li>
</ul>
<br />
His clinical acumen was sharpened during his years with Jiva Ayurveda, where he handled a diverse range of complex cases. Today, he balances his practice with a prestigious role as an Associate Professor at Rama Medical University, where he mentors the next generation of Ayurvedic physicians.
            </p>
  ...
  return (
    <div className="border-b border-gray-200 pb-4">
      ...
      >
        ...
        <span className="text-[#C4531A] text-xl">
          {open ? "−" : "+"}
        </span>
      </button>
